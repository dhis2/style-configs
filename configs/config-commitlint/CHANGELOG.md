...
- 03f01fa: feat: add shared commitlint config, matching the rules cli-style's bundled config used

### Patch Changes

- 403aeba: fix: rework `@dhis2/config-lslint`'s ruleset to scope to conventional source directories (at
